    ...
    private void seedExperience() {
        ...
        experienceRepository.saveAll(List.of(
                Experience.builder()
                        ...
                        .description(
                                "Applied machine learning, API integration, cloud deployment, and data visualization using Agile practices. Built AI-based web applications on IBM Cloud with Python, Flask, and Watson AI services for intelligent automation.")
                        .sortOrder(1)
                        .build(),
                Experience.builder()
                        ...
                        .location("Remote, India")
                        .description(
                                "Developed and deployed MERN-based web applications with React, Node.js, Express, and MongoDB. Built a freelancing platform that lifted user engagement by 30% through a responsive UI and REST API integration.")
                        .sortOrder(2)
                        .build(),
                Experience.builder()
                        ...
                        .location("India")
                        .description(
                                "Completed a comprehensive employability training program covering soft skills, presentation skills, and professional communication.")
                        .sortOrder(3)
                        .build()));
    }
    ...
    private void seedCertificates() {
        ...
        List<C> certs = List.of(
                ...
                new C(
                        ...
                        "IBM",
                        "Jan 2024",
                        "ibm-data-visualization.png",
                        "https://drive.google.com/file/d/1PD2_ta5NqRjblyV1uG5DKq_l3qwgtMR5/view"),
                ...
                new C(
                        ...
                        "Dec 2024",
                        "genai.png",
                        "https://www.linkedin.com/learning/certificates/304c35122ef0e86e457a44ff8f0388372d218f0e4b11e80a42517d3fd8f28210?trk=share_certificate"),
                ...
                new C(
                        ...
                        "Mar 2025",
                        "ibm-data-visualization.png",
                        "https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/ifobHAoMjQs9s6bKS/gmf3ypEXBj2wvfQWC_ifobHAoMjQs9s6bKS_iT6hzAH7SB9MQ7ykr_1742835388668_completion_certificate.pdf"),
                ...
                new C(
                        ...
                        "Mar 2025",
                        "tata-cyber.png",
                        "https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/ifobHAoMaKS/MyXvBcppsW2FkNYCX_ifobHAoMjQs9s6bKS_iT6hzAH7SB9MQ7ykr_1742986027064_completion_certificate.pdf"),
                ...
                new C(
                        ...
                        "https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/pmnMSL4QiQ9JCgE3W/kkE9HyeNcw6rwCRGw_pmnMSL4QiQ9JCgE3W_iT6hzAH7SB9MQ7ykr_1742898977689_completion_certificate.pdf"),
                ...
                new C(
                        ...
                        "Apr 2025",
                        "mern.png",
                        "https://skillwallet.smartinternz.com/certificate/virtual-internship/d65862e5c9c83c81bb456b82791a198c"),
                ...
                new C(
                        ...
                        "Aug 2025",
                        "ibm-ai-cloud.png",
                        "https://drive.google.com/file/d/1_tlF_IiXPnwhnFn6JpeEYCG6XdBdNQZ3/view"),
                ...
                new C(
                        ...
                        "Jul 2025",
                        "ibm-ai.png",
                        "https://drive.google.com/file/d/1oIXJLYHhSfEozMH4oCtOrFjc7h9nm8J5/view"),
                ...
                new C(
                        ...
                        "Jul 2025",
                        "ibm-cloud.png",
                        "https://drive.google.com/file/d/1T3XUd_wZiOjcgIKX9UeBi_XytQFjMazg/view"),
                ...
                new C(
                        ...
                        "Jul 2025",
                        "ibm-rag.png",
                        "https://drive.google.com/file/d/1M4PsmYEu1b2Iptiv4-l34ufFfGS5UN8U/view"),
                ...
                new C(
                        ...
                        "2025",
                        "ServiceNow.png",
                        "https://drive.google.com/file/d/1hROYgqoF4AZWKXmVc10r-6t9hpvl9kTV/view"));
    ...
    private void seedAchievements() {
        ...
        achievementRepository.saveAll(List.of(
                Achievement.builder()
                        ...
                        .value("8.40 CGPA")
                        .description(
                                "Maintained a strong academic record throughout the B.Tech program at Maharana Pratap Engineering College.")
                        .sortOrder(1)
                        .build(),
                Achievement.builder()
                        ...
                        .value("10+")
                        .description(
                                "Earned certifications across AI, cloud, cybersecurity, and full-stack development from IBM, Microsoft, AWS, and Tata & Forage.")
                        .sortOrder(2)
                        .build(),
                Achievement.builder()
                        ...
                        .value("2")
                        .description(
                                "Completed internships in AI & Cloud (Edunet Foundation × IBM SkillBuild) and Full Stack Development (SmartBridge & SmartInternz).")
                        .sortOrder(3)
                        .build(),
                Achievement.builder()
                        ...
                        .value("+30%")
                        .description(
                                "Improved user engagement by 30% on a MERN-stack freelancing platform through a responsive UI and REST API integration.")
                        .sortOrder(4)
                        .build(),
                Achievement.builder()
                        ...
                        .value("Completed")
                        .description(
                                "Completed a comprehensive employability training program covering soft skills, presentation, and communication.")
                        .sortOrder(5)
                        .build()));
    }
}
