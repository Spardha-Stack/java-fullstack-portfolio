...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center px-6 md:px-10 pt-32 pb-16 relative overflow-hidden">
      {/* R3F scene: particles, floating cubes, rotating tech core, mouse parallax */}
      <HeroScene />
      <CodeSnippets />
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center w-full relative z-10">
        ...
        >
          ...
          <p className="text-white/60 leading-relaxed max-w-md mb-8">{profile.summary}</p>
        ...
        >
          ...
          <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full p-1.5 bg-gradient-to-tr
