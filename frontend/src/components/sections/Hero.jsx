...
function useTypingEffect(words = [], speed = 65, pause = 1400) {
  const safeWords =
    words.length > 0 ? words : ['Java Full Stack Developer'];
  ...
  }, [text, deleting, wordIndex, safeWords, speed, pause]);
...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center px-6 md:px-10 pt-32 pb-16 relative overflow-hidden"
    >
      <HeroScene />
      <CodeSnippets />
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-15 items-center w-full relative z-10">
        ...
        >
          ...
          <h1
            ...
            bg-gradient-to-r from-white via-neon-cyan to-neon-violet
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <a href="/SpardhaShukla_Resume.pdf" download className="btn-ghost">
              Download Resume
            </a>
          </div>
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                ...
                bg-white/5 border border-white/10 hover:border-neon-cyan
                hover:text-neon-cyan hover:-translate-y-1
        ...
        >
          <div
            ...
            bg-gradient-to-tr from-neon-blue via-neon-cyan to-neon-violet
            blur-2xl opacity-30 animate-spin-slow"
          />

          <div
            className="relative w-80 h-80 md:w-[455px] md:h-[455px]
            rounded-full p-1.5 bg-gradient-to-tr
