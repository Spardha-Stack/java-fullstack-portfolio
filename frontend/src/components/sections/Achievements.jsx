        ...
        {achievements.map((a, i) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <span className="w-11 h-11 rounded-xl bg-neon-violet/10 border border-neon-violet/25
                flex items-center justify-center text-neon-violet">
                <FaTrophy size={18} />
              </span>
              <span className="font-display font-bold text-xl bg-gradient-to-r from-neon-cyan to-neon-violet
                bg-clip-text text-transparent">
                {a.value}
              </span>
            </div>
            <h3 className="font-display font-semibold text-base mb-1.5">{a.title}</h3>
            <p className="font-mono text-[11px] text-neon-cyan mb-3 uppercase tracking-wide">{a.category}</p>
